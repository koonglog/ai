...
def event_features_from_sensor_row(
    ...
    *,
    ...
    parsed_ts = (
        _parse_datetime(row.get("sensor_timestamp"))
        or _parse_datetime(row.get("timestamp"))
        or _parse_datetime(row.get("received_at"))
    ...
    return EventFeatures(
        ...
        vibration_value=max(0, _safe_int(row.get("vibration_value"), 0)),
...
def feature_dict_from_event(
    ...
    *,
    ...
    return {
        ...
        "vibration_over_low": float(max(0, vibration_value - thresholds.vibration_low)),
        "vibration_over_mid": float(max(0, vibration_value - thresholds.vibration_mid)),
        "vibration_over_high": float(max(0, vibration_value - thresholds.vibration_high)),

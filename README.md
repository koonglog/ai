...
- 소음 임계값
  - `AI_DIRECT_IMPACT_LEQ_DAY`, `AI_DIRECT_IMPACT_LEQ_NIGHT`
  - `AI_DIRECT_IMPACT_LMAX_DAY`, `AI_DIRECT_IMPACT_LMAX_NIGHT`
  - `AI_AIRBORNE_LEQ_DAY`, `AI_AIRBORNE_LEQ_NIGHT`
  - `AI_DIRECT_IMPACT_EXTRA_DB` (구축/특례 단지 가산치)
  - (하위 호환) `AI_DB_BACKGROUND`, `AI_DB_DAILY`, `AI_DB_IMPACT`
  - `AI_VIBRATION_LOW`, `AI_VIBRATION_MID`, `AI_VIBRATION_HIGH`
  - `AI_DURATION_SHORT_MS`, `AI_DURATION_MEDIUM_MS`, `AI_DURATION_LONG_MS`
- 야간 시간대
  - `AI_NIGHT_START_HOUR`, `AI_NIGHT_END_HOUR` (기본 `22:00~06:00`)
- 패턴 분석
